...
- Make-up flow: spend a card to make up yesterday.
- OP visual editor: edit 7-day loop rewards in GUI.
- Multi-item rewards: each day can contain multiple items, with NBT/component text support.
...
1. Put `signin-1.0.0.jar` into server `mods`.
2. Put the same `signin-1.0.0.jar` into client `mods` (recommended).
